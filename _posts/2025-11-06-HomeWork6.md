...
<head>
  ...
  <title>Online Mean and Variance (Welford’s Algorithm)</title>
...
<body>
  ...
  <div class="container">
    <h1>📊 Online Mean and Variance Estimation</h1>
    <h3>(Welford’s Algorithm with Chart.js Visualization)</h3>
    ...
    <p>
      ...
      <br><br>
      The <strong>Welford’s online algorithm</strong> efficiently updates these statistics as new data arrives — using constant memory and ensuring numerical stability.
    </p>
