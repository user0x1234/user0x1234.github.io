...
2) What is a dataset (From the observation units to the dataset. Attributes and variables)
3) Find and list interesting application of Statistics to Cybersecurity problems

## Applications / Practice (A)
(Visual Studio)
Create simple apps in c# and VB to play with handlers, understanding differences between the two languages. 
