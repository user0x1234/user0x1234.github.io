...
|                          **C#**                           |                          **VB**                           |
|:-------------------------------------------------------:  |:--------------------------------------------------------: |
|         _It supports structured error handling_           | _It supports structured and unstructured error handling_  |
| _Event handling is a bit complex in contrast to VB.NET_   |                _Event handling is simpler_                |
|             _Events are not possible in C#_               |             _Events are automatically bound_              |    
### Syntax Differences
